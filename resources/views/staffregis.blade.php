...
@section('content')
    <div id="content" class="p-5">
        ...
        <form method="post" id="staffRegisForm" onsubmit="return checkChoice();">
            @csrf
    ...
    <script>
        ...
        function checkChoice() {
            document.getElementById('name_txt').required = true;
            document.getElementById('id_txt').required = true;
